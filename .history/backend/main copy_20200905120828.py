...
def set_cookies():
    ...
    global logged_user = loggedUser(id = user_id)
...
class loggedUser(object):
    ...
    def set_user_info(self):
        if int(user_id) in boys.id.values:
            self.gender = "boy"
            self.swipe_data_path = PATH_BOYS_SWIPE_DIR + '/{0}.csv'.format(user_id)
            self.match_path = PATH_BOYS_SWIPE_DIR + '/{0}.log'.format(user_id)
        elif int(user_id) in girls.id.values:
            self.gender = "girl"
            self.swipe_data_path  = PATH_GIRLS_SWIPE_DIR + '/{0}.csv'.format(user_id)
            self.match_path = PATH_GIRLS_SWIPE_DIR + '/{0}.log'.format(user_id)
        

def match():
    """"""
    user_match_path = PATH_BOYS_SWIPE_DIR + '/{0}.log'.format(user_id)
